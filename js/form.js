...
//this is the array of activities as string form that is generated when the list is rearranged 
var activityArr = [];  

//this is the array of objects that have a name, time, and pic. the create, store, and get list functions all use it
var activityObjects = []; 
...
//this is the list from the sortable library
...
function buttonAdd(){
	...
	//give the custom activity a name and a time value 	
	setTimeout(function(){
		activityArr = myList.toArray(); //generate array of strings when list is updated
		estimateTime(); //estimate time when list is updated 
	}, 100);
